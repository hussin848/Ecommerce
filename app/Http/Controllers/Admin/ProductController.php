  ...
  //  $data['buyone_getone'] = $request->buyone_getone;
    ...
    if ($image_one && $image_two && $image_three) {
     ...
     $product = DB::table('products')->insert($data);
      $notification=array(
            'message_id'=>'Product Inserted Successfully',
            'alert-type'=>'success'
             );
...
public function inactive($id){
    ...
    $notification=array(
            'message_id'=>'Product Successfully inactive',
            'alert-type'=>'success'
             );
           return Redirect()->back()->with($notification);
   }
    ...
    $notification=array(
            'message_id'=>'Product Successfully Active',
            'alert-type'=>'success'
             );
           return Redirect()->back()->with($notification);
   }
 ...
 public function DeleteProduct($id){
   ...
   $notification=array(
            'message_id'=>'Product Successfully Deleted',
            'alert-type'=>'success'
             );
           return Redirect()->back()->with($notification);
 ...
 public function UpdateProductWithoutPhoto(Request $request,$id){
   ...
   // $data['buyone_getone'] = $request->buyone_getone;
    ...
    if ($update) {
      $notification=array(
            'message_id'=>'Product Successfully Updated',
            'alert-type'=>'success'
             );
 ...
 public function UpdateProductPhoto(Request $request,$id){
  ...
  if ($image_one) {
    ...
    $productimg = DB::table('products')->where('id',$id)->update($data);
     $notification=array(
            'message_id'=>'Image One Updated Successfully',
            'alert-type'=>'success'
             );
           return Redirect()->route('all.product')->with($notification);
  }
  if ($image_two) {
    ...
    $productimg = DB::table('products')->where('id',$id)->update($data);
     $notification=array(
            'message_id'=>'Image Two Updated Successfully',
            'alert-type'=>'success'
             );
           return Redirect()->route('all.product')->with($notification);
  ...
  if ($image_three) {
    ...
    $productimg = DB::table('products')->where('id',$id)->update($data);
     $notification=array(
            'message_id'=>'Image Three Updated Successfully',
            'alert-type'=>'success'
             );
           return Redirect()->route('all.product')->with($notification);
  }
