...
<div class="contact_form">
        <div class="container">
         <div class="row">
          ...
          <div class="col-lg-5 offset-lg-1" style="border: 1px solid red; padding: 20px; border-radius: 25px;">
...
<div class="col-lg-5 offset-lg-1" style="border: 1px solid green; padding: 20px; border-radius: 25px;"> 
                    <div class="contact_form_container">
