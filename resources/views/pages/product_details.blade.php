			...
			<div class="row">
				...
				<div class="col-lg-5 order-3">
					<div class="product_description">
						...
						<div class="product_text"><p>{!! str_limit($product_detalis ?? '', $limit = 600 ) !!}</p></div>
								...
								<div class="clearfix" style="z-index: 1000;">
									...
									<div class="col-lg-4">
										<div class="from-group">
											...
											<input type="numder" name="qty" class="form-control" value="1" pattern="[0-9]">
										</div>
									</div>
...
<div class="row">
	<div class="col-lg-4">
		<div class="from-group">
			<label class="exampleFormControlSelect1">Color </label>
			<select class="form-control input-lg" id="exampleFormControlSelect1" name="color">@foreach($product_color as $color) <option value="{{$color}}">{{$color}}</option> @endforeach</select>
...
<div class="col-lg-4">
	<div class="from-group">
		<label class="exampleFormControlSelect1">Size </label>
			<select class="form-control input-lg" id="exampleFormControlSelect1" name="size">@foreach($product_size as $size) <option value="{{$size}}">{{$size}}</option> @endforeach</select>
...
@if($product->discount_price == NULL)
								...
								@else
									<div class="product_price">${{$product->discount_price}}<span>${{$product->selling_price}}</span></div>@endif
...
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/ar_AR/sdk.js#xfbml=1&version=v10.0" nonce="X22M9eiL"></script>
