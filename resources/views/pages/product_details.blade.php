...
@section('content')
                ...
                <div class="col-lg-5 order-3">
                    <div class="product_description">
                        ...
                        <div class="product_text">
                            <p>{!! str_limit($product_detalis ?? '', $limit = 600) !!}</p>
                        </div>
    ...
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/ar_AR/sdk.js#xfbml=1&version=v10.0"
        nonce="X22M9eiL"></script>
